...
/**
 * Basic password validation strategy for {@code ESTAGIARIO} users.
 *
 * <p>Rules enforced:
 * <ul>
 *   <li>Minimum 6 characters, maximum 128 characters.</li>
 *   <li>Must not equal the login or the email.</li>
 *   <li>Must contain at least <b>2 of 4</b> character types: uppercase letters,
 *       lowercase letters, digits, and special characters.</li>
 * </ul>
 * </p>
 *
 * <p>This is the most permissive policy, applied to intern-level users who have
 * limited access to sensitive data within the system.</p>
 */
public class BasicPasswordStrategy implements PasswordValidationStrategy {

    private static final int MIN_LENGTH = 6;
    private static final int MAX_LENGTH = 128;
    private static final int REQUIRED_COMPLEXITY_TYPES = 2;
    ...
    public void validate(String password, String login, String email) {
        ...
        if (password.length() < MIN_LENGTH || password.length() > MAX_LENGTH) {
            throw new IllegalArgumentException(
                ...
                + " characters long (Basic policy for Estagiário)");
        }
        ...
        if (score < REQUIRED_COMPLEXITY_TYPES) {
            throw new IllegalArgumentException(
                "Password must contain at least 2 of the following character types: "
                + "uppercase letters, lowercase letters, digits, and special characters "
                + "(Basic policy for Estagiário)");
        }
    }
}
